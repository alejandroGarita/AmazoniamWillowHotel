...
namespace AmazoniamWillowHotel.Models
{
    ...
    public partial class Hotel_Amazonian_WillowEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> sp_insertImage(string nombre, byte[] imagen)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("sp_insertImage", nombreParameter, imagenParameter);
        }
        ...
        public virtual ObjectResult<InsertImage_Result> InsertImage(string nombre, byte[] imagen)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("nombre", nombre) :
                new ObjectParameter("nombre", typeof(string));
